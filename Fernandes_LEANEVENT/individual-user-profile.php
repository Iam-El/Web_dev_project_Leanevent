...
include_once '../backend/update-individual-profile.php';
...
<header>
    <div class="header-content">
        ...
        <div class="menu">
            <nav class="nav-bar">
                <ul>
                    <li class="link"><a href="individual-user-homepage.php">Inicio</a></li>
                    <li class="link active"><a href="individual-user-profile.php">Individual</a></li>
                </ul>
            </nav>
        </div>
    </div>
...
<div class="mainpage individual-user-profile">
    ...
    <div class="position-center">
        ...
        <div class="update-profile">
            ...
            <form enctype="multipart/form-data" class="update-profile-form" method="POST" onsubmit="validate_profile(event,this)">
