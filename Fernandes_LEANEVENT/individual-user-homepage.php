...
<header>
    <div class="header-content">
        ...
        <div class="menu">
            <nav class="nav-bar">
                <ul>
                    <li class="link active"><a href="individual-user-homepage.php">Inicio</a></li>
                    <li class="link"><a href="individual-user-profile.php">Individual</a></li>
                </ul>
            </nav>
        </div>
    </div>
...
<div class="mainpage individual-user-homepage">
    ...
    <div class="position-center">
        <table class="events-table lean-table">
            ...
            <?php include_once '../backend/display-individual-events.php'; ?>
            </tbody>
