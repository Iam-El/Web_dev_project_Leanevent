...
include '../backend/update-agent-profile.php';
                ...
                <div class="column3x">
                    ...
                    <div class="item">
                        <div class="individual-profile"><span
                                    class="fas fa-map-marker fa-1x"></span><?php echo $user["address"]; ?>
                        </div>
                    </div>
                    <div class="item">
                        <div class="individual-profile"><span
                ...
                <form enctype="multipart/form-data" id="update-profile-form" method="POST" onsubmit="validate_profile(event,this)">
                    ...
                    <div class="row">
                        <div class="phone column3x full-width">
                            ...
                            <input id="phone" type="text" placeholder="xxx-xxx-xxxx" class="field" name="phone"
                                   value="<?php echo $user["phone"]; ?>" required pattern="^\d{3}-\d{3}-\d{4}$"/>
                        </div>
                        ...
                        <div class="password column3x full-width">
                            <label for="password">Contrasena <span
                                        ...
                                        class="error-label-format hidden">*This Field is Invalid</span></label>
                            <input id="password" type="password" placeholder="0 to 8 Non Space characters" class="field" name="password"
                                   value="<?php echo $user["password"]; ?>" required pattern="^\S{0,8}$"/>
                        </div>
                    </div>
                    <div class="row">
